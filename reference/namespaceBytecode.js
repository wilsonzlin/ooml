const NAMESPACE_BYTECODE_OBJECT_STRUCTURE = {
  classes: {
    "SomeClass": {
      ...
      parent: class SomeOOMLClass {
      } || undefined,

      memberNames: new StringSet(),

      constructor: function unbindedConstructor () {
      } || undefined,
      initialiser: function init () {
      } || undefined,

      fields: {
        static_var: 1,
        static_var_2: "test",
        static_var_3: function () {
        }.bind(class ThisOOMLClass {
        }),
      },
      ...
      properties: {
        nameOfProp: {
          types: ["string", "natural", "null"] || class SomeOOMLClass {
          } || undefined,

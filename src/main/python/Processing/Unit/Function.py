...
from Processing.Unit.Parameter import Parameter


class Function:
    def __init__(self, *, name: str,
                 pos_params: List[Parameter], pos_collect_param: Optional[str] = None,
                 kw_params: Optional[Dict[str, Parameter]] = None, kw_collect_param: Optional[str] = None,

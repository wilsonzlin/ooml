ooml.Table = function (element_type, initial_elems) {
  let _this = this;
...
let oomlTablePrototype = ooml.Table.prototype = Object.create(ooml.EventSource.prototype);
let oomlTableMutationPrototype = u_new_clean_object();
